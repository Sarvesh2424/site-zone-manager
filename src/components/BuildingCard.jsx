...
const BuildingCard = memo(({ building, dispatch, removeBuilding }) => {
  const [layout, layoutDispatch] = useReducer(reducer, { gate: "", exit: "" });
      ...
      <div className="flex items-center gap-2 justify-between">
        ...
        {addingNote && mode.mode === "edit" && (
          <div className="flex gap-2">
            <button
              onClick={() => {
                dispatch({ type: "ADD_NOTE", id: building.id, note });
                setNote("");
              }}
